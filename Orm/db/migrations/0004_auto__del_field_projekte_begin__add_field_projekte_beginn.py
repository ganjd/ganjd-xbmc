...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Projekte.begin'
        db.delete_column('db_projekte', 'begin')

        # Adding field 'Projekte.beginn'
        db.add_column('db_projekte', 'beginn',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Projekte.begin'
        db.add_column('db_projekte', 'begin',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Deleting field 'Projekte.beginn'
        db.delete_column('db_projekte', 'beginn')
    ...
    models = {
        ...
        'db.projekte': {
            ...
            'beginn': ('django.db.models.fields.DateField', [], {'null': 'True'}),
