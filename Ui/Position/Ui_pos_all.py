...
# Form implementation generated from reading ui file 'L:\Python Projekte\Galabau-2\Ui\Position\pos_all.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.treeWidget.header().setMinimumSectionSize(27)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QtGui.QApplication.translate("Form", "Positionen", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setTitle(QtGui.QApplication.translate("Form", "Alle Positionen", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.treeWidget.headerItem().setText(0, QtGui.QApplication.translate("Form", "Beschreibung", None, QtGui.QApplication.UnicodeUTF8))
